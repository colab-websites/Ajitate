export function BurgerGlyph({ className = "" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M14 28c0-8 12-16 20-16s20 8 20 16" stroke="#e53935" strokeWidth="3" strokeLinecap="round" fill="none" />
      <path d="M10 36h48" stroke="#e53935" strokeWidth="3" strokeLinecap="round" />
      <path d="M12 42h44" stroke="#e53935" strokeWidth="2.5" strokeLinecap="round" />
      <path d="M14 48h40" stroke="#e53935" strokeWidth="2" strokeLinecap="round" />
      <path d="M18 52c0 4 10 7 16 7s16-3 16-7" stroke="#e53935" strokeWidth="2.5" strokeLinecap="round" fill="none" />
    </svg>
  )
}
